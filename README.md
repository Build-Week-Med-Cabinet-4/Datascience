...
Example input package POST request to ```https://med-cabinet-4-api.herokuapp.com/recommend``` Content-Type must be equal to ```“application/json”``` in the header.
```
{
